...
public class UserSchedulesInnerPanel extends JPanel {
    ...
    public UserSchedulesInnerPanel(Dimension size, String course_Name, String subject, String term, int units, String professor, String ID, Time start_time, Time end_time, boolean Monday, boolean Tuesday,  boolean Wednesday,  boolean Thursday,  boolean Friday,  boolean Saturday, boolean Sunday){
        super();
